...
# transforms_masked_val = tt.Compose([
...
#                                 window_size=window_size,
#                                 signal_window_size=signal_window_size,
#                                 transforms=transforms_masked_val)
...
val_dataset = create_dataset(root_dir=root_dir_unmasked,
                                mice_names=train_mice_names,
                                trails_to_load=val_trails,
                                window_size=window_size,
                                signal_window_size=signal_window_size,
...
test_dataset = create_dataset(root_dir=root_dir_unmasked,
                                mice_names=test_mice_names,
                                trails_to_load=None,
                                window_size=window_size,
                                signal_window_size=signal_window_size,
