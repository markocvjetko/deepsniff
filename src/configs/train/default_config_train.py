...
transforms = tt.Compose([tt.RandomHorizontalFlip(p=0.5),
                        tt.RandomRotation(30),
                        tt.RandomResizedCrop(224, scale=(0.8, 1.0), ratio=(0.75, 1.3333333333333333), antialias=True),
...
test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=256, shuffle=False, num_workers=10)